...
// for every step it was noted if it was an uphill, U, or a downhill, D step. Hikes always start and end
...
func countingValleys(steps int32, path string) int32 {
	...
	actualLevel := 0
	var actualLevelPtr *int = &actualLevel
	isValley := actualLevel < 0
